...
class LiveExamResultScreen extends StatefulWidget {
  LiveExamResultScreen({required this.id, super.key});
  String id;
  @override
                              ...
                              child: Column(
                                children: [
                                    ...
                                    children: [
                                      CircularPercentIndicator(
                                        ...
                                        percent: resultOfProgress(cubit
                                            ...
                                            .toString()),
                                        center: new Text(
                                          cubit.resultExam!.data.studentDegree
                                              .toString(),
                                          style: TextStyle(
                                              fontSize: getSize(context) / 32,
                                              fontWeight: FontWeight.w700),
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                        cubit.resultExam!.data.motivationalWord,
                                        style: TextStyle(
                                          fontSize: getSize(context) / 32,
                                                          ...
                                                          radius: cubit
                                                              ...
                                                              : cubit
                                                                  ...
                                                                  : getSize(
                                                                      ...
                                                                      30,
                                                          child: MySvgWidget(
                                                              path: (cubit.resultExam!.data.examQuestions.questions[currentQuestion].answers[index2].id ==
                                                                          cubit
                                                                              .resultExam!
                                                                              .data
                                                                              .examQuestions
